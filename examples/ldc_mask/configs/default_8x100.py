...
def get_config():
    ...
    wandb.name = "default-VP-400-NE-21"
    wandb.tag = None
    ...
    masked.mask_training_interval = 2000  # Run masked training every x steps
    masked.mask_training_steps = 500    # Number of masked training steps
    masked.threshold_percentile = 90  # Percentile for identifying bad subspace
    ...
    sequential.adam_steps = 10000  # Number of ADAM steps
    sequential.lbfgs_steps = 5000  # Number of L-BFGS steps
